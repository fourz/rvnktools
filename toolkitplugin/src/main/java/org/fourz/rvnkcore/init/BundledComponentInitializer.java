...
/**
 * Initializer for bundled RVNKTools components.
 *
 * <p>This class follows the Single Responsibility Principle (SRP) by handling
 * only the initialization, registration, and shutdown of bundled RVNKTools
 * components, extracted from the main RVNKCore plugin class.</p>
 *
 ...
 * @see ServiceRegistry
 */
public class BundledComponentInitializer {
    ...
    /**
     * Creates a new BundledComponentInitializer.
     *
     * @param plugin The RVNKCore plugin instance
     * @param registry The ServiceRegistry for component registration
     */
    public BundledComponentInitializer(RVNKCore plugin, ServiceRegistry registry) {
        this.plugin = plugin;
    ...
    /**
     * Initializes all bundled RVNKTools components.
     *
    ...
    public void initializeAll() {
        ...
        logger.debug("Initializing bundled RVNKTools components...");
        ...
        logger.info("Bundled components initialized: ToolsConfig, Permissions, Economy, LinkMaker, AnnounceManager, API, Events, CommandManager, LogFilter (" + totalTime + "ms)");
    }

    /**
     * Shuts down all bundled components in reverse initialization order.
     */
